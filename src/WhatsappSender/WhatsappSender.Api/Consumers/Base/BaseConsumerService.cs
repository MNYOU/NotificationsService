...
namespace WhatsappSender.Api.Consumers.Base;

public abstract class BaseConsumerService : IConsumerService, IAsyncDisposable
{
    ...
    protected BaseConsumerService(IOptions<RabbitMqOption> options, ISendManager sender)
    {
