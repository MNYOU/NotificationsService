...
{
    public static ActionResult<TResult> ToActionResult<TResult>(this OperationResult<TResult> result,
        StatusCode statusCode = StatusCode.Ok) =>
        result.ToActionResult(result.IsSuccess ? result.Result : default!, statusCode);

    public static ActionResult<TResult> ToActionResult<TData, TResult>(this OperationResult<TData> result,
        Func<TData, TResult> mapper, StatusCode statusCode = StatusCode.Ok) =>
        result.IsSuccess
    ...
    public static ActionResult<TResult> ToActionResult<TResult>(this OperationResult result, Func<TResult> provider,
        StatusCode statusCode = StatusCode.Ok) =>
        result.IsSuccess
            ? new ObjectResult(provider()) { StatusCode = (int) statusCode }
            : new ObjectResult(result.Error) { StatusCode = (int) result.Error!.StatusCode };

    public static ActionResult<TResult> ToActionResult<TResult>(this OperationResult result, TResult data,
        StatusCode statusCode = StatusCode.Ok) =>
        result.IsSuccess
